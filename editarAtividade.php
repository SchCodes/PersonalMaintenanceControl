...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($titulo) || empty($equipamento_id) || empty($data_inicio)) {
        ...
        try {
            ...
            } elseif ($imagem_antes_blob) {
                $campos[] = 'imagem_antes = ?';
                $valores[] = $imagem_antes_blob;
            }
            
            // Tratar imagem depois
            if ($excluir_imagem_depois) {
                $campos[] = 'imagem_depois = NULL';
            } elseif ($imagem_depois_blob) {
                $campos[] = 'imagem_depois = ?';
                $valores[] = $imagem_depois_blob;
            }
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php if (!empty($atividade['imagem_antes'])): ?>
                                    <div class="mt-2">
                                        <small class="text-info">Foto atual disponível</small>
                                        <br>
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($atividade['imagem_antes']); ?>" 
                                             class="img-fluid mt-1" style="max-width: 200px;" alt="Foto antes">
                                        <br>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Formatos aceitos: JPG, JPEG, PNG. Máximo 10MB.</small>
                                <?php if (!empty($atividade['imagem_depois'])): ?>
                                    <div class="mt-2">
                                        <small class="text-info">Foto atual disponível</small>
                                        <br>
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($atividade['imagem_depois']); ?>" 
                                             class="img-fluid mt-1" style="max-width: 200px;" alt="Foto depois">
                                        <br>
                                        <div class="form-check mt-2">
